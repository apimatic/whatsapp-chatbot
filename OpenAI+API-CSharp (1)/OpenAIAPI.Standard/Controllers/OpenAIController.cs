...
namespace OpenAIAPI.Standard.Controllers
{
    ...
    using OpenAIAPI.Standard.Http.Request;
    using OpenAIAPI.Standard.Http.Request.Configuration;
    ...
    public class OpenAIController : BaseController
    {
        ...
        internal OpenAIController(IConfiguration config, IHttpClient httpClient, IDictionary<string, IAuthManager> authManagers, HttpCallBack httpCallBack = null)
        ...
        {
            Task<Models.ListEnginesResponse> t = this.ListEnginesAsync();
        ...
        public Models.Engine RetrieveEngine(
                string engineId)
        {
            Task<Models.Engine> t = this.RetrieveEngineAsync(engineId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.CreateCompletionResponse> t = this.CreateCompletionAsync(body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.CreateEditResponse> t = this.CreateEditAsync(body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.CreateEmbeddingResponse> t = this.CreateEmbeddingAsync(body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.CreateSearchResponse> t = this.CreateSearchAsync(engineId, body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.ListFilesResponse> t = this.ListFilesAsync();
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.OpenAIFile CreateFile(
                ...
                string purpose)
        {
            Task<Models.OpenAIFile> t = this.CreateFileAsync(file, purpose);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.DeleteFileResponse DeleteFile(
                string fileId)
        {
            Task<Models.DeleteFileResponse> t = this.DeleteFileAsync(fileId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.OpenAIFile RetrieveFile(
                string fileId)
        {
            Task<Models.OpenAIFile> t = this.RetrieveFileAsync(fileId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public string DownloadFile(
                string fileId)
        {
            Task<string> t = this.DownloadFileAsync(fileId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.CreateAnswerResponse> t = this.CreateAnswerAsync(body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.CreateClassificationResponse> t = this.CreateClassificationAsync(body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.FineTune> t = this.CreateFineTuneAsync(body);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.ListFineTunesResponse> t = this.ListFineTunesAsync();
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        /// <param name="cancellationToken"> cancellationToken. </param>
        /// <returns>Returns the Models.ListFineTunesResponse response from the API call.</returns>
        public async Task<Models.ListFineTunesResponse> ListFineTunesAsync(CancellationToken cancellationToken = default)
        {
            // the base uri for api requests.
            string baseUri = this.Config.GetBaseUri();
        ...
        public Models.FineTune RetrieveFineTune(
                string fineTuneId)
        {
            Task<Models.FineTune> t = this.RetrieveFineTuneAsync(fineTuneId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.FineTune CancelFineTune(
                string fineTuneId)
        {
            Task<Models.FineTune> t = this.CancelFineTuneAsync(fineTuneId);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.ListFineTuneEventsResponse ListFineTuneEvents(
                ...
                bool? stream = false)
        {
            Task<Models.ListFineTuneEventsResponse> t = this.ListFineTuneEventsAsync(fineTuneId, stream);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        {
            Task<Models.ListModelsResponse> t = this.ListModelsAsync();
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.Model RetrieveModel(
                string model)
        {
            Task<Models.Model> t = this.RetrieveModelAsync(model);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
        ...
        public Models.DeleteModelResponse DeleteModel(
                string model)
        {
            Task<Models.DeleteModelResponse> t = this.DeleteModelAsync(model);
            ApiHelper.RunTaskSynchronously(t);
            return t.Result;
        }
